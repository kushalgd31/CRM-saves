...
function BackdropDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-4 font-bold" component="h1">Backdrop</Typography>
...
<Typography className="text-base mb-8" component="div">The Backdrop signals a state change within the application and can be used for creating loaders, dialogs, and more.
In its simplest form, the Backdrop component will add a dimmed layer over your application.</Typography>
<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Example</Typography>
<Typography className="text-base mb-8" component="div">The demo below shows a basic Backdrop with a Circular Progress component in the foreground to indicate a loading state.
