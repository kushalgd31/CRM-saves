...
function ProgressDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-4 font-bold" component="h1">Progress</Typography>
...
<Typography className="text-base mb-8" component="div">Progress indicators inform users about the status of ongoing processes, such as loading an app, submitting a form, or saving updates.</Typography>
...
<Typography className="text-base mb-8" component="div">The animations of the components rely on CSS as much as possible to work even before the JavaScript is loaded.</Typography>
<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Circular</Typography>
<Typography className="text-lg mt-5 mb-2.5 font-bold" component="h3">Circular indeterminate</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-lg mt-5 mb-2.5 font-bold" component="h3">Circular color</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-lg mt-5 mb-2.5 font-bold" component="h3">Circular size</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    raw={CircularSizeRaw}
                    /></Typography>
<Typography className="text-lg mt-5 mb-2.5 font-bold" component="h3">Circular determinate</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-lg mt-5 mb-2.5 font-bold" component="h3">Circular track</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-lg mt-5 mb-2.5 font-bold" component="h3">Interactive integration</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-lg mt-5 mb-2.5 font-bold" component="h3">Circular with label</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Linear</Typography>
<Typography className="text-lg mt-5 mb-2.5 font-bold" component="h3">Linear indeterminate</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-lg mt-5 mb-2.5 font-bold" component="h3">Linear color</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
                    name="LinearColor.js"
                    className="my-4"
                    iframe={false}
                    ...
                    raw={LinearColorRaw}
                    /></Typography>
<Typography className="text-lg mt-5 mb-2.5 font-bold" component="h3">Linear determinate</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-lg mt-5 mb-2.5 font-bold" component="h3">Linear buffer</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    raw={LinearBufferRaw}
                    /></Typography>
<Typography className="text-lg mt-5 mb-2.5 font-bold" component="h3">Linear with label</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Non-standard ranges</Typography>
<Typography className="text-base mb-8" component="div">The progress components accept a value in the range 0 - 100. This simplifies things for screen-reader users, where these are the default min / max values. Sometimes, however, you might be working with a data source where the values fall outside this range. Here&#39;s how you can easily transform a value in any range to a scale of 0 - 100:</Typography>
...
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Delaying appearance</Typography>
<Typography className="text-base mb-8" component="div">There are <a href="https://www.nngroup.com/articles/response-times-3-important-limits/">3 important limits</a> to know around response time.
...
<Typography className="text-lg mt-5 mb-2.5 font-bold" component="h3">High CPU load</Typography>
<Typography className="text-base mb-8" component="div">Under heavy load, you might lose the stroke dash animation or see random <code>{`CircularProgress`}</code> ring widths.
...
<Typography className="text-base mb-8" component="div">When it&#39;s not possible, you can leverage the <code>{`disableShrink`}</code> prop to mitigate the issue.
...
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-lg mt-5 mb-2.5 font-bold" component="h3">High frequency updates</Typography>
<Typography className="text-base mb-8" component="div">The <code>{`LinearProgress`}</code> uses a transition on the CSS transform property to provide a smooth update between different values.
...
<Typography className="text-base mb-8" component="div">If you need to perform 30 re-renders per second or more, we recommend disabling the transition:</Typography>
