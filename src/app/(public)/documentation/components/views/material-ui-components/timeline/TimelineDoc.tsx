...
function TimelineDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-4 font-bold" component="h1">Timeline</Typography>
...
<Typography className="text-base mb-8" component="div">This component is not documented in the <a href="https://m2.material.io/">Material Design guidelines</a>, but it is available in Material UI.</Typography>
</div>



<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Basic timeline</Typography>
<Typography className="text-base mb-8" component="div">A basic timeline showing list of events.</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Left-positioned timeline</Typography>
<Typography className="text-base mb-8" component="div">The main content of the timeline can be positioned on the left side relative to the time axis.</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Alternating timeline</Typography>
<Typography className="text-base mb-8" component="div">The timeline can display the events on alternating sides.</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Reverse Alternating timeline</Typography>
<Typography className="text-base mb-8" component="div">The timeline can display the events on alternating sides in reverse order.</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
...
<Typography className="text-base mb-8" component="div">The <code>{`TimelineDot`}</code> can appear in different colors from theme palette.</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Outlined</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Opposite content</Typography>
<Typography className="text-base mb-8" component="div">The timeline can display content on opposite sides.</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
...
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Alignment</Typography>
<Typography className="text-base mb-8" component="div">There are different ways in which a Timeline can be placed within the container.</Typography>
<Typography className="text-base mb-8" component="div">You can do it by overriding the styles.</Typography>
<Typography className="text-base mb-8" component="div">A Timeline centers itself in the container by default.</Typography>
<Typography className="text-base mb-8" component="div">The demos below show how to adjust the relative width of the left and right sides of a Timeline:</Typography>
<Typography className="text-lg mt-5 mb-2.5 font-bold" component="h3">Left-aligned</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-lg mt-5 mb-2.5 font-bold" component="h3">Right-aligned</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-lg mt-5 mb-2.5 font-bold" component="h3">Left-aligned with no opposite content</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
