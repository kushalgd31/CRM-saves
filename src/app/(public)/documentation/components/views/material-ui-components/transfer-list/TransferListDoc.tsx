...
function TransferListDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-4 font-bold" component="h1">Transfer List</Typography>
...
<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Basic transfer list</Typography>
<Typography className="text-base mb-8" component="div">For completeness, this example includes buttons for &quot;move all&quot;, but not every transfer list needs these.</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    raw={TransferListRaw}
                    /></Typography>
<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Enhanced transfer list</Typography>
<Typography className="text-base mb-8" component="div">This example exchanges the &quot;move all&quot; buttons for a &quot;select all / select none&quot; checkbox and adds a counter.</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
...
<Typography className="text-base mb-8" component="div">The component comes with a couple of limitations:</Typography>
