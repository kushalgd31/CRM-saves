...
function PopperDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-4 font-bold" component="h1">Popper</Typography>
...
<Typography className="text-base mb-8" component="div">Some important features of the Popper component:</Typography>
<ul className="space-y-4">
<li>🕷 Popper relies on the 3rd party library (<a href="https://popper.js.org/docs/v2/">Popper.js</a>) for perfect positioning.</li>
<li>💄 It&#39;s an alternative API to react-popper. It aims for simplicity.</li>
<li>Its child element is a <a href="/material-ui/react-portal/">Portal</a> on the body of the document to avoid rendering problems.
...
If you need this behavior, you can use the <a href="/material-ui/react-click-away-listener/">Click-Away Listener</a> - see the example in the <a href="/material-ui/react-menu/#composition-with-menu-list">menu documentation section</a>.</li>
<li>The <code>{`anchorEl`}</code> is passed as the reference object to create a new <code>{`Popper.js`}</code> instance.</li>
</ul>
<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Basic Popper</Typography>
...
<Typography className="text-base mb-8" component="div">The open/close state of the popper can be animated with a render prop child and a transition component.
...
<Typography className="text-base mb-8" component="div">Popper has built-in support for <a href="https://github.com/reactjs/react-transition-group">react-transition-group</a>.</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
...
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    raw={SpringPopperRaw}
                    /></Typography>
<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Positioned popper</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Scroll playground</Typography>
<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Virtual element</Typography>
<Typography className="text-base mb-8" component="div">The value of the <code>{`anchorEl`}</code> prop can be a reference to a fake DOM element.
...
<Typography className="text-base mb-8" component="div">Highlight part of the text to see the popper:</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
...
<Typography className="text-base mb-8" component="div">The package <a href="https://github.com/jcoreio/material-ui-popup-state"><code>{`material-ui-popup-state`}</code></a> that takes care of popper state for you in most cases.</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
