...
function ContainerDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-4 font-bold" component="h1">Container</Typography>
...
<Typography className="text-base mb-8" component="div">While containers can be nested, most layouts do not require a nested container.</Typography>
<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Fluid</Typography>
<Typography className="text-base mb-8" component="div">A fluid container width is bounded by the <code>{`maxWidth`}</code> prop value.</Typography>
...
<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Fixed</Typography>
<Typography className="text-base mb-8" component="div">If you prefer to design for a fixed set of sizes instead of trying to accommodate a fully fluid viewport, you can set the <code>{`fixed`}</code> prop.
