...
function SpeedDialDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-4 font-bold" component="h1">Speed Dial</Typography>
...
<Typography className="text-base mb-8" component="div">If more than six actions are needed, something other than a FAB should be used to present them.</Typography>
<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Basic speed dial</Typography>
<Typography className="text-base mb-8" component="div">The floating action button can display related actions.</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Playground</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Controlled speed dial</Typography>
<Typography className="text-base mb-8" component="div">The open state of the component can be controlled with the <code>{`open`}</code>/<code>{`onOpen`}</code>/<code>{`onClose`}</code> props.</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Custom close icon</Typography>
<Typography className="text-base mb-8" component="div">You can provide an alternate icon for the closed and open states using the <code>{`icon`}</code> and <code>{`openIcon`}</code> props
...
<Typography className="text-base mb-8" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-6 mb-2.5 font-bold" component="h2">Persistent action tooltips</Typography>
<Typography className="text-base mb-8" component="div">The SpeedDialActions tooltips can be displayed persistently so that users don&#39;t have to long-press to see the tooltip on touch devices.</Typography>
<Typography className="text-base mb-8" component="div">It is enabled here across all devices for demo purposes, but in production it could use the <code>{`isTouch`}</code> logic to conditionally set the prop.</Typography>
<Typography className="text-base mb-8" component="div"><FuseExample
...
<Typography className="text-base mt-3 mb-2.5" component="h4">Required</Typography>
<ul className="space-y-4">
<li>You should provide an <code>{`ariaLabel`}</code> for the speed dial component.</li>
<li>You should provide a tooltip title using <code>{`slotProps.tooltip.title`}</code> for each speed dial action.</li>
</ul>
<Typography className="text-base mt-3 mb-2.5" component="h4">Provided</Typography>
<ul className="space-y-4">
